...
import gradingTools.gradebook.SummaryDiaryManagementCanvas;

public class Comp524DiarySummaryToCanvasFileGenerator {
...
//	static Boolean[] isDiary = {true, false};
	static Boolean[] isDiary = {false, true};
...
//	static final String GRADES_DIR = "G:\\My Drive\\524\\f23\\grades\\";
	static final String GRADES_DIR = "G:\\My Drive\\524\\f24\\grades\\";
...
//				onyensToEmail);
		new SummaryDiaryManagementCanvas().diarySummaryToCanvas(				
				dates, 
				GRADES_DIR +
